...
const PdfRenderer = ({ url }: PdfRendererProps) => {
  ...
  return (
    <div className="flex w-full flex-col items-center rounded-md bg-white shadow">
      <div className="flex h-14 w-full items-center justify-between border-b border-slate-200 px-2">
        <div className=" flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <p className="flex items-center justify-center space-x-1 text-sm text-slate-700">
              <span>/</span>
              <span>
                {numPages ?? (
